      ...
      <div class="mainbar">
        <div class="article">
          ...
          <table width="500" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
            <tr>
              <td width="108" height="30" bgcolor="#FFFF00"><div align="center" class="style33"> ID </div></td>
              <td width="183" bgcolor="#FFFF00"><div align="center" class="style33">Data Owner  Name </div></td>
              <td width="171" bgcolor="#FFFF00"><div align="center" class="style33"> Status </div></td>
              <%	  

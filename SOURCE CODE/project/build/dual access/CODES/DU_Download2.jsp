        ...
        <div class="article">
          ...
          <div class="entry">
			...
			try 
			{
				...
				String contk=request.getParameter("t134");
				String msk=request.getParameter("t1343");
				String user=(String)application.getAttribute("uname");
				

				
				String ct="",contk1="",msk1="";
				String str="Attacked";
					...
					if(rs1.next()==true)
					{
							...
							{
								ct=rs1.getString(3);
								contk1=rs1.getString(4);
								msk1=rs1.getString(5);


								if(contk1.equalsIgnoreCase(contk))
								{
										if(msk1.equalsIgnoreCase(msk))
										{
            ...
            <div align="center">
              ...
              <td><button onclick="saveTextAsFile()">Download</button>
                  <p align="right"><a href="DU_Main.jsp">Back</a></p></td>
            </div>
            </label>
              <%
										}
										...
										String strQuer1 = "insert into attacker(user,fname,sk,dt,attacktype) values('"+user+"','"+file+"','"+msk+"','"+dt+"','Secret Key Attack')";
            ...
            <p><a href="DU_Main.jsp">Back</a></p>
              <%
								...
								else
								{
									...
									String strQuer1 = "insert into attacker(user,fname,sk,dt,attacktype) values('"+user+"','"+file+"','"+contk+"','"+dt+"','Content Key Attack')";
									connection.createStatement().executeUpdate(strQuer1);

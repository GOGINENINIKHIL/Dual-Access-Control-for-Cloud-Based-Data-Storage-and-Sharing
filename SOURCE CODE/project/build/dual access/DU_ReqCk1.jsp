	...
	SimpleDateFormat sdfDate = new SimpleDateFormat("dd/MM/yyyy");
		...
		if ( rs1.next())
		{
			...
			if ( rs.next()==true)
			{
				...
				contentkey=rs.getString(6);
				if(contentkey.equalsIgnoreCase("Requested"))
				{
					%>
          </p>
          <p class="style30">Request Already Sent To Cloud !</p>
          <p class="style28"><a href="DU_Main.jsp" class="style3">Back</a></p>
          <%
				}
				else if(contentkey.equalsIgnoreCase("No"))
				{
					String query3="update request set contentkey='Requested' where user='"+uname+"' and owner='"+owner+"' and fname='"+fname+"'";
					connection.createStatement().executeUpdate(query3);
					
					%>
          <p class="style30">Request Sent To Cloud !</p>
          <p><a href="DU_Main.jsp" class="style3">Back</a></p>
          <%
				}
				else
				{
...
String query4="insert into request(user,owner,fname,secretkey,contentkey) values('"+uname+"','"+owner+"','"+fname+"','No','Requested')";

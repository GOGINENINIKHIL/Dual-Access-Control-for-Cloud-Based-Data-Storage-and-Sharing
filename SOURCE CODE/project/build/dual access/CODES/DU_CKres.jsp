...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Content Key Response</span></h2>
          <p><span class="style1">Role : (<%=application.getAttribute("urole")%>)</span></p>
          <p>&nbsp;</p>
          <form id="form" name="form1" method="post" action="DU_CKres1.jsp">
            <div align="center" class="style19">
              <p><br />
                <span class="style35">Enter File Name</span> :
                <input required="required" name="t14" type="text" size="30" />
        <br />
        <br />
        <input type="submit" name="Submit" value="Find Content Key" />
              </p>
              <p>&nbsp; </p>
            </div>
          </form>
          <%String key=(String)application.getAttribute("key");
			  if(key!=(null))
			  {%>
          <p align="center" class="style19"><strong>Content Key : <%=key%>&nbsp;</strong></p>

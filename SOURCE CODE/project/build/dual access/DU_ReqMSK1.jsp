...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span> (MSK) Request status</span></h2>
	...
	SimpleDateFormat sdfDate = new SimpleDateFormat("dd/MM/yyyy");
		...
		if ( rs1.next())
		{
			...
			if ( rs.next()==true)
			{
				...
				msk=rs.getString(5);
				if(msk.equalsIgnoreCase("Requested"))
				{
					%>
          </p>
          ...
          <%
				...
				else if(msk.equalsIgnoreCase("No"))
				{
...
String query4="insert into request(user,owner,fname,secretkey,contentkey) values('"+uname+"','"+owner+"','"+fname+"','Requested','No')";

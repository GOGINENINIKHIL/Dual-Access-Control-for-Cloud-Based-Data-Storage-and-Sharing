...
.style38 {font-size: 14; color: #FF0000; font-weight: bold; }
-->
</style>
</head>
<body>
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Request Content Key</span></h2>
          <p><span class="style22">Role : (<%=application.getAttribute("urole")%>)</span></p>
          <p>&nbsp;</p>
          <form action="DU_ReqCk1.jsp" method="post" id="leavereply">
            <div align="center">
              <table width="523" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <th height="48" scope="row"><span class="style38">Enter Owner Name :&nbsp;</span></th>
                  <td><span class="style17">
                    <input name="t142" type="text" size="30" />
                  </span></td>
                </tr>
                <tr>
                  <th height="35" scope="row"><span class="style38"> Enter File Name :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></th>
                  <td><span class="style17">
              ...
              <p align="center" class="style17">
                <input name="Submit" type="submit" class="style38" value="Request Content Key" />
              </p>

...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>(MSK) Master Secret Key Response</span></h2>
          <p><span class="style1">Role : (<%=application.getAttribute("urole")%>)</span></p>
          <p>&nbsp;</p>
          <form id="form" name="form1" method="post" action="DU_MSKres1.jsp">
        ...
        <br />
        <br />
        <input type="submit" name="Submit" value="Find MSK" />
              </p>
              <p>&nbsp; </p>
            </div>
          </form>
          <%String key=(String)application.getAttribute("key");
			  if(key!=(null))
			  {%>
          <p align="center" class="style19"><strong>MSK Key : <%=key%>&nbsp;</strong></p>

    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p><em><strong>Select Files Added &amp; Request Master Secret Key(MSK) And Content Key To Authority And Then Upload . </strong></em></p>
          <p>&nbsp;</p>
          <form id="form1" name="form1" method="post" action="DO_Upload1.jsp">
            <label> <strong class="odd style3 style10">
            <%
			String dname=(String)application.getAttribute("doname");
		ArrayList al=new ArrayList();
		String str="select fname from ownerfiles where downer='"+dname+"'";
		...
		%>
            ...
            <p>&nbsp;            </p>
            <p>
              <input type="submit" name="Submit2" value="View Keys &amp; Upload" />
            </p>
          </form>
          <p>&nbsp;</p>
        </div>

...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Master Secret Key(MSK) User Requests </span></h2>
          <p>&nbsp;</p>
          <table width="618" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0" align="center">
            <tr>
              <td width="66" height="30" bgcolor="#FFFF00"><div align="center" class="style33"> ID </div></td>
              <td width="127" bgcolor="#FFFF00"><div align="center" class="style33">User Name </div></td>
              <td width="116" bgcolor="#FFFF00"><div align="center" class="style33">Owner Name </div></td>
              <td width="127" bgcolor="#FFFF00"><div align="center" class="style33">File Name </div></td>
              <td width="123" bgcolor="#FFFF00"><div align="center" class="style33">Secret Key </div></td>
		    </tr> 
              <%	  

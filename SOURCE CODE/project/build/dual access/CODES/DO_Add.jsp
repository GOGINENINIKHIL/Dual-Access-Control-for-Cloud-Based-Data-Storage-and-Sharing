...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Select File To Add </span></h2>
          <p>&nbsp;</p>
          <form id="form1" method="post" action="DO_Add2.jsp">
            <table width="553" border="0" align="center"  style="border-collapse:collapse" cellpadding="0" cellspacing="0">
              <tr>
                <td width="286" height="32" bgcolor="#FFFF00"><span class="odd style14 style28"><span class="odd style11 style16 style33"> Select File :</span></span></td>
                <td width="356"><input required="required" type="file" name="t42" id="fileupload" onchange="loadFileAsText();" /></td>
              </tr>
              <tr>
                <td height="43" bgcolor="#FFFF00" class="odd style14 style28"><span class="odd style11 style16 style33">File Name :</span> </td>
              ...
              <tr>
                ...
                <td><input type="submit" name="Submit" value="Add File" /></td>
              </tr>
            </table>
          </form>

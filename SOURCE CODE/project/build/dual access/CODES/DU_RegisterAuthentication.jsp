...
<%
					...
					try {
						...
						while (params.hasMoreElements()) 
						{
							...
							if(paramname.equalsIgnoreCase("urole"))
							{
								urole=multi.getParameter(paramname);
							}
						...
						if(urole.equalsIgnoreCase("-Select-"))
					{
								out.println("Please Select The Role To Continue...");							
								%>
							<p><a href="DU_Register.jsp">Back</a>         <a href="index.html">Home</a> </p>
					...
					if ( rs1.next() )
					   ...
					   {
					  PreparedStatement ps=connection.prepareStatement("insert into user(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status,urole) values(?,?,?,?,?,?,?,?,?,?,?,?)");

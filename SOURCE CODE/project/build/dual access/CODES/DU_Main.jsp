      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="DU_ReqMSK.jsp">Request MSK </a></li>
            <li><a href="DU_Download.jsp">Download File</a> </li>
            <li><a href="DU_MSKres.jsp">MSK Response</a></li>
            <li><a href="DU_ReqCk.jsp">Request Content Key</a></li>
            <li><a href="DU_CKres.jsp">Content Key Response</a></li>
            <li><a href="DU_Login.jsp">Logout</a></li>
          </ul>
        </div>

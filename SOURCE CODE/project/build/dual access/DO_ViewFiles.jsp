    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p>&nbsp;</p>
          <table width="628" border="1.5" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
            <%	  
...
try 
	{		
            ...
            <tr>
              ...
              <td width="97" bgcolor="#FFFF00"><div align="center" class="style35">File Name </div></td>
              <td width="257" bgcolor="#FFFF00"><div align="center" class="style35">Content Key</div></td>
              <td width="104" bgcolor="#FFFF00"><div align="center" class="style35">Secret Key</div></td>
              <td width="111" bgcolor="#FFFF00"><div align="center" class="style35">View </div></td>
            </tr>
            <%
